...
export function App() {
  return (
    <div className="min-h-screen flex flex-col">
      <div className="px-6 pv-6 flex items-center justify-between border-b">
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Lembre-se você pode utilizar a <code className="text-violet-400">{'{variável}'}</code> transcription no seu prompt para adicionar o conteúdo da transcrição do vídeo selecionado
          </p>
        </div>
